...
<?php  
	...
	if(isset($btnlogin))
	{
  		...
  		$result=@mysqli_query($con,"select * from freelancer where f_username='$username' and password='$pass' ") or die(mysqli_error($con));  
...
<body>
	...
	<div class="limiter">
		...
		<div class="se-right">Create an account<a href="signup.php">  Sign Up</a></div>
		</nav>
